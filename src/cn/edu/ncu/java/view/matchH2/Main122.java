 ...
 * 作者姓名           修改时间           版本号              描述
 **/
package cn.edu.ncu.java.view.matchH2;
...
public class Main122 extends Application {
    public Main122() {
    }
    public void start(Stage primaryStage) throws Exception {

        Parent root = (Parent) FXMLLoader.load(this.getClass().getResource("images13/matchH.fxml"));
       ...
       pane.getStylesheets().add(
            getClass().getResource("images13/MainStyleH.css").toExternalForm());
        primaryStage.show();
    }
