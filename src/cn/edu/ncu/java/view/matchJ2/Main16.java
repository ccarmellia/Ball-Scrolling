 ...
 * 作者姓名           修改时间           版本号              描述
 **/
package cn.edu.ncu.java.view.matchJ2;
...
public class Main16 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Parent root = (Parent) FXMLLoader.load(this.getClass().getResource("images12/matchJ.fxml"));
        ...
        pane.getStylesheets().add(
              getClass().getResource("images12/MainStyle.css").toExternalForm());
        primaryStage.show();
    }
