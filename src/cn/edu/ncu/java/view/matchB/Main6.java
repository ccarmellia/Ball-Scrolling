...
public class Main6 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Parent root = (Parent) FXMLLoader.load(this.getClass().getResource("image4/matchB.fxml"));
        primaryStage.setTitle("男子乙组");
      ...
      BorderPane pane = new BorderPane();
        pane.getStylesheets().add(
              getClass().getResource("image4/MainStyle.css").toExternalForm());
        primaryStage.show();
    }
